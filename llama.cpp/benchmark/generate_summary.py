...
def main():
    ...
    print("| Model | Size | ROCm | MI50 PP512 | R9700 PP512 | MI50 PP(32k) | R9700 PP(32k) |")
    print("| --- | --- | --- | --- | --- | --- | --- |")
    for (model, rocm) in sorted(data.keys()):
        ...
        print(f"| {model} | {size} | {rocm} | {mi50_pp512} | {r9700_pp512} | {mi50_pp32k} | {r9700_pp32k} |")
        
    print("\n#### Text Generation (TG) Throughput")
    print("| Model | Size | ROCm | MI50 TG128 | R9700 TG128 | MI50 TG(32k) | R9700 TG(32k) |")
    print("| --- | --- | --- | --- | --- | --- | --- |")
    for (model, rocm) in sorted(data.keys()):
        row = data[(model, rocm)]
        size = row.get("size", "-")
        ...
        print(f"| {model} | {size} | {rocm} | {mi50_tg128} | {r9700_tg128} | {mi50_tg32k} | {r9700_tg32k} |")
